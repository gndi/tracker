<table class="table table-sm table-hover">
  ...
  <tbody>
    ...
    $info = $row['info'];
    $table .= '<tr><th>Information</th><td>' . $info . '</td></tr>';
    $power = $row['power'];
    $table .= '<tr><th>Power</th><td>' . $power . '</td></tr>';
    $phone = $row['phone'];
    $table .= '<tr><th>Phone</th><td>' . $phone . '</td></tr>';
    $phone2 = $row['phone2'];
    $table .= '<tr><th>Another Phone</th><td>' . $phone2 . '</td></tr>';
    $lon = $row['lon'];
    $table .= '<tr><th>Longitude</th><td>' . $lon . '</td></tr>';
    $lat = $row['lat'];
    $table .= '<tr><th>Latitude</th><td>' . $lat . '</td></tr>';
    $adress = $row['adress'];
    $table .= '<tr><th>Adress</th><td>' . $adress . '</td></tr>';
    $state_ = $row['state_'];
    $table .= '<tr><th>State</th><td>' . getstatename($db, $state_) . '</td></tr>';
    $locality = $row['locality'];
    $table .= '<tr><th>Locality</th><td>' . getlocalityname($db, $locality) . '</td></tr>';
    $owner_name = $row['owner_name'];
    $table .= '<tr><th>Owner Name</th><td>' . $owner_name . '</td></tr>';
    $owner_contact = $row['owner_contact'];
    $table .= '<tr><th>Owner Contact</th><td>' . $owner_contact . '</td></tr>';
    $project_manager = $row['project_manager'];
    $table .= '<tr><th>Project Manager</th><td>' . $project_manager . '</td></tr>';
    $stakeholders = $row['stakeholders'];
    $table .= '<tr><th>Stakeholders</th><td>' . $stakeholders . '</td></tr>';
    $i_teams = $row['i_teams'];
    $table .= '<tr><th>Inspection teams</th><td>' . $i_teams . '</td></tr>';
    $r_t_contacts = $row['r_t_contacts'];
    $table .= '<tr><th>Resistance team contacts</th><td>' . $r_t_contacts . '</td></tr>';

    $init_budget = $row['init_budget'];
    $table .= '<tr><th>Initial budget in SDG</th><td>' . $init_budget . '</td></tr>';
    $e_f_date = $row['e_f_date'];
    $table .= '<tr><th>Expected finishing date</th><td>' . $e_f_date . '</td></tr>';
    $i_date = $row['i_date'];
    $table .= '<tr><th>Inspection date</th><td>' . $i_date . '</td></tr>';
    $i = 0;
    $h = '';
    while ($i <= 1) {
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $table .= '<tr><th>Medical Usage</th><td>' . getmu($medical_usage) . '</td><td>' . $h1 . '</td></tr>';
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $table .= '<tr><th>Building Status</th><td>' . getbs($building_status) . '</td><td>' . $h1 . '</td></tr>';
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $owner_acceptance = $row['owner_acceptance'];
    $table .= '<tr><th>Owner Acceptance</th><td>' . getoa($owner_acceptance) . '</td><td>' . $h1 . '</td></tr>';
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $resistnce_acceptance = $row['resistnce_acceptance'];
    $table .= '<tr><th>Resistance Acceptance</th><td>' . getoa($resistnce_acceptance) . '</td><td>' . $h1 . '</td></tr>';
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $table .= '<tr><th>Readiness Status</th><td>' . getrs($readiness_status) . '</td><td>' . $h1 . ' </td></tr>';
  ...
  <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
    ...
    $table .= '<tr><th>Building Type</th><td>' . getbt($building_type) . '</td><td>' . $h1 . '</td></tr>';
    $i = 0;
    $h = '';
