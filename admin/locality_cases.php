...
include('./session.php');
include('./header.php');
if ($login_permission == 2 or $login_permission == 0 or $login_permission == 6) {
} else {
...
<div class="row">
    ...
    <script>
        ...
        function userslist() {
            ...
            var loc_id = <?php echo $user_locality; ?>;
            xhr.open('GET', '<?php echo $sitelink; ?>admin/cases_table.php?cookie=' + cookie + '&q=' + q + '&state=' + st1 + '&loc=' + loc1 + '&locality_id=' + loc_id, true);
