...
document.getElementById('editModalLabel2').innerHTML=title;
document.getElementById('edittxt').value=txt;
document.getElementById('edittxt').name=col;
document.getElementById('hc__id').value=id;

}else{
document.getElementById('edittxt').outerHTML=document.getElementById('edittxt').outerHTML.replace(/textarea/g,'input');
  document.getElementById('editModalLabel').innerHTML=title;
document.getElementById('editModalLabel2').innerHTML=title;
document.getElementById('edittxt').value=txt;
document.getElementById('edittxt').type=type;
document.getElementById('edittxt').name=col;
document.getElementById('hc__id').value=id;
}
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Issue log</h5>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="set_hc_val.php" method="GET">
          
          <div class="form-group">
            <label for="message-text" id="editModalLabel2" class="col-form-label">value</label>
            <textarea class="form-control" id="edittxt"></textarea>

          </div>
        
      </div>
      <input type="hidden" name="text" value="true">
      <input type="hidden" name="id" id="hc__id">
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
