          ...
          <div class=" row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="form-control" name="building_type" id="building_type">
                <option value='1000' selected>Select value</option>
